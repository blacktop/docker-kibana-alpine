...
```bash
REPOSITORY          TAG                 SIZE
blacktop/kibana     latest              145 MB
blacktop/kibana     5.3                 145 MB
blacktop/kibana     x-pack              339 MB
